globals [  %infected num_deaths num_infected num_healed ]
breed [people person]
;breed [visons vison]
;breed [bats bat]
    ...
    if state = "infected" [
      ask other turtles-here [
        ...
        [
          ...
          ;set color red
          set time_in_this_state 0
          get_infected ;; i add this instead the two lines above that don't update the number of infected

        ]
      ]
      if random 100 < mortality [
          set state "dead"
          set color grey ; i change the color for dead people
